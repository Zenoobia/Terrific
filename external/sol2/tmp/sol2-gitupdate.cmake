...
execute_process(
  COMMAND "F:/Program Files/Git/cmd/git.exe" show-ref origin/develop
  WORKING_DIRECTORY "W:/terrific/external/sol2/src/sol2"
...
if("${show_ref_output}" MATCHES "refs/remotes/origin/develop")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "origin/develop")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "origin/develop")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "F:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 origin/develop
  WORKING_DIRECTORY "W:/terrific/external/sol2/src/sol2"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'W:/terrific/external/sol2/src/sol2/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'W:/terrific/external/sol2/src/sol2/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "F:/Program Files/Git/cmd/git.exe" checkout origin/develop
      WORKING_DIRECTORY "W:/terrific/external/sol2/src/sol2"
      RESULT_VARIABLE error_code
      )
    if(error_code)
